...
const handleOnChangeSelect = (evento, value) => {
  console.log('Valore selezionato:', value);
    setFormValues({
        ...formValues, selettore: value});
      console.log("Nuovo stato di formValues:", formValues);
};
          ...
          <form className="registrazione" onSubmit={onSubmitF}>
            ...
            <div className="Dati">
              ...
              <label className="label" htmlFor="selettore">
                ...
                options={[
                  { value: "Errore Pagamenti", label: "Errore Pagamenti" },
                  {
                    value: "Gestione Prenotazioni",
